...
const HOME_COPY = localized(
  ...
  {
    es: {
      tagline: 'Todo en tu dispositivo · nada sale de tu teléfono',
      overwhelmSub: 'Divide cualquier tarea en pasos tranquilos — mejora con el uso',
      energySub: 'Mira tus ventanas de concentración y descanso de hoy',
      hydrationSub: 'Mantén el ritmo con una meta diaria personalizada',
      expenseSub: 'Escanea recibos o sube PDFs — todo en tu dispositivo',
    },
    fr: {
      tagline: 'Tout sur l’appareil · rien ne quitte votre téléphone',
      overwhelmSub: 'Découpez toute tâche en étapes sereines — s’améliore à l’usage',
      energySub: 'Vos fenêtres de concentration et de repos du jour',
      hydrationSub: 'Gardez le rythme avec un objectif quotidien personnalisé',
      expenseSub: 'Scannez des reçus ou importez des PDF — tout sur l’appareil',
    },
    de: {
      tagline: 'Alles auf dem Gerät · nichts verlässt dein Handy',
      overwhelmSub: 'Zerlege jede Aufgabe in ruhige Schritte — wird mit der Nutzung schlauer',
      energySub: 'Deine Fokus- und Ruhefenster für heute',
      hydrationSub: 'Bleib dran mit einem persönlichen Tagesziel',
      expenseSub: 'Belege scannen oder PDFs laden — alles auf dem Gerät',
    },
    it: {
      tagline: 'Tutto sul dispositivo · nulla lascia il tuo telefono',
      overwhelmSub: 'Dividi ogni attività in passi sereni — migliora con l’uso',
      energySub: 'Le tue finestre di concentrazione e riposo di oggi',
      hydrationSub: 'Tieni il ritmo con un obiettivo giornaliero personalizzato',
      expenseSub: 'Scansiona scontrini o carica PDF — tutto sul dispositivo',
    },
    pt: {
      tagline: 'Tudo no aparelho · nada sai do seu telefone',
      overwhelmSub: 'Divida qualquer tarefa em passos tranquilos — melhora com o uso',
      energySub: 'Veja suas janelas de foco e descanso de hoje',
      hydrationSub: 'Mantenha o ritmo com uma meta diária personalizada',
      expenseSub: 'Escaneie recibos ou envie PDFs — tudo no aparelho',
    },
    hi: {
    ...
    th: {
      tagline: 'ทุกอย่างบนเครื่อง · ไม่มีอะไรออกจากโทรศัพท์ของคุณ',
      overwhelmSub: 'แบ่งงานใด ๆ เป็นขั้นตอนสบาย ๆ — ยิ่งใช้ยิ่งฉลาด',
      energySub: 'ดูช่วงสมาธิดีและช่วงพักของวันนี้',
      hydrationSub: 'ดื่มน้ำให้ตามเป้ารายวันที่ปรับให้เหมาะกับคุณ',
      expenseSub: 'สแกนใบเสร็จหรืออัปโหลด PDF — ทั้งหมดบนเครื่อง',
    },
  },
);
